...
var _search_ui = __webpack_require__(16);

var _search_ui2 = _interopRequireDefault(_search_ui);
...
var Search_ui = function (_React$Component) {
	_inherits(Search_ui, _React$Component);

	function Search_ui() {
		_classCallCheck(this, Search_ui);

		return _possibleConstructorReturn(this, (Search_ui.__proto__ || Object.getPrototypeOf(Search_ui)).call(this));
	}

	_createClass(Search_ui, [{
		key: "handle_onchange",
		value: function handle_onchange(event) {
...
exports.default = Search_ui;


var wrapper = document.getElementById("create-search-form");
wrapper ? _reactDom2.default.render(_react2.default.createElement(Search_ui, null), wrapper) : false;
